...
os.chdir('/home/innereye/JWST/M16/')
path = ['MAST_2022-10-21T1450/JWST/jw02739-o001_t001_nircam_clear-f090w/jw02739-o001_t001_nircam_clear-f090w_i2d.fits',
        'MAST_2022-10-21T1450/JWST/jw02739-o001_t001_nircam_clear-f200w/jw02739-o001_t001_nircam_clear-f200w_i2d.fits',
        'MAST_2022-10-21T1450/JWST/jw02739-o001_t001_nircam_clear-f444w/jw02739-o001_t001_nircam_clear-f444w_i2d.fits']
...
if os.path.isfile('crop.pkl'):
    ...
    for ii in range(len(path)):
        ...
        if ii == 0:
            ...
            orig = hdu0[1].copy()
            ref, ref_pos, ref_pix = crop_fits(orig, [9500, 1300], [1080+margins, 1920+margins])  # [4400, 6200]
            img = ref.data
...
plt.imsave('middle_finger_rgb.png', np.flipud(np.fliplr(rgbt)), origin='lower')
...
plt.show()
# plt.imsave('middle_finger.png', rgbt, origin='lower')
