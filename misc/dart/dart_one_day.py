...
out = cv2.VideoWriter(stuff+date+'.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 3, (300, 300), False)
for ii in range(frames):
    d = np.nanmean(cube[:,:,int(ii*10):int(ii*10+10)], axis=2)
...
out = cv2.VideoWriter(stuff+date+'Full.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 30, (300, 300), False)
