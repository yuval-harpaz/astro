...
if os.path.isfile(pkl):
    ...
    for ii in range(len(path)):
        ...
        if ii == 0:
            ...
            orig = hdu0[1].copy()
            ref, ref_pos, ref_pix = crop_fits(orig, [11380, 1720], [1080+margins, 1920+margins])  # [4400, 6200]
            img = ref.data
...
plt.imsave('right_finger_rgb.png', np.flipud(np.fliplr(rgbt)), origin='lower')
