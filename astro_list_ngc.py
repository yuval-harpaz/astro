...
def list_ngc():
    ...
    isnotbackground = []
    background = ['BACKGROUND', 'BCKGND', 'BG', 'BK', 'OFFSET', '-OFF', 'SKY', 'J0305M3150', 'M0416', 'MRGP0918', 'UDS-', 'MRGM0150']
    ...
    misc = ['Cartwheel', 'Comet', 'Antennae', 'Hoag', 'Arp', 'Pinwheel', 'TRAPEZIUM', 'N5584', 'Leo-P', 'SERPENS', 'Jet_Center',
            ...
            '2MASS-J16313679-2404200', 'FLYING-SAUCER','G286', 'SICKLE', 'Combined_Final_Catalog', 'Solar_System_Target']
